...
((* 2 99) 5)
;expect Error: int is not callable: 198

($ (* 5 7) (/ 52 0)) 
; expect Error: unknown identifier: $

(+ (print-then-return 7 5) (/ 1 0))
; expect 7 ; Error:
...
a
;expect (lambda (b c d) + c d)

(define (a b c d) (> 1 2))
; expect a

a
;expect (lambda (b c d) (> 1 2))

(define (increment_1 x) (+ x 1))
;expect increment_1

(increment_1 4)
;expect 5

(increment_1 (increment_1 4))
;expect 6

(increment_1 (increment_1 (* 3 (/ 4 2))))
;expect 8

(define (first a b) (define (second c d) (+ c (- a (* d b)))) second)
;expect first
...
first
;expect (lambda (a b) (define (second c d) (+ c (- a (* d b)))) second)

(define (final y z) ((first y 2) z 2))
;expect final
...
(cond ((< 2 1) 1) ((> 2 1) (+ 5 3)) (else 3))
;expect 8

(cond ((< 2 1) 1) ((< 2 1) (+ 5 3)) (else 'a))
;expect a
...
((lambda (x y) (let ((x 1) (y 2)) (+ x y))) 7 8)
;expect 3

((lambda (x y) (let ((x x) (y 2)) (+ x y))) 7 8)
;expect 9
...
(define b (lambda (x y) (a (+ y x))))
;expect b

(b 3 5)
;expect 13

(equal? (quote hello) 'hello)
;expect #t
...
'(3 ,'0, '(0) 0)
; expect (3 (unquote (quote 0)) (unquote (quote (0))) 0)

`((list 2 3) ,(list (list '(1 2))))
; expect ((list 2 3) (((1 2))))

(define a (begin (display 9) (newline) (* 9 10)))
; expect 9 ; a
a
; expect 90

(define a -18)
(define x (define y (lambda (b) (+ (/ b 9) a))))
; expect x
...
((lambda (x) (* x x)) ((print-then-return 5 - ) 10 1))
; expect 5 ; 81
